...
# How to Setup
1. Download the B:AC Manual AP and put it in your Archipelago/custom_worlds folder.
2. In the Archipelago Client, click on "Generate Template Options" to get the YAML file for the AP.
3. Download the APWorld from Manual for Archipelago's "Manual" GitHub page and put it in your Archipelago/custom_worlds folder.
